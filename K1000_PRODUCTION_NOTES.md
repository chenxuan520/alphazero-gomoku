...
2026-09-15 死区回看（`tools/k1000_deadzone_scan.sh`，对非常旧的 iter440 作有限样本对照）：
- best90 checkpoint：43-21-0（sims 48/96 各 32 局）
- best105：44-20-0
- latest123：45-19-0
这三个读数只说明「后段存档没有系统性坏掉」，不构成对 best80 的晋升证据；真正的晋级线仍要回到 §4 的多 sims 头对头 + L6/L7 横测。
